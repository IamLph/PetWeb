    ...
    <div class='container'>
        ...
        <div class='border'>
            ...
            >
                ...
                <el-table-column prop='id' label='用户id' align='center' min-width='100'></el-table-column>
                <el-table-column prop="userName" label="用户名" min-width="100" align="center"></el-table-column>
                <el-table-column prop="passWord" label="密码" min-width='100' align='center'></el-table-column>
        ...
        <!-- 添加弹出框 -->
        <el-dialog title="添加用户基本信息" :visible.sync="addVisible" width="30%">
    ...
    export default {
        ...
        methods: {
            ...
            saveEdit() {
                ...
                let data = {id:this.form.id,userName:this.form.userName,passWord:this.form.passWord};
                this.$axios.put('user/update_user',this.$qs.stringify(data))
                    .then(res =>{
            ...
            handleDelete(index,row){
                ...
                this.$confirm('确定删除该用户吗?','提示',{
                    ...
                    let id = row.id;
                    this.$axios.delete('/user/delete_user/' + id)
                        .then(res =>{
