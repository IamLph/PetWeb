                ...
                <div class="container crhr3-a xiantiao foots">
                    <div class="row ptb25 tac fs16 cr38-a  bb1 bcw20 bsd  pb30all h20pxall br1all bsdall bcw20all ">
                        <div class="col-sm-5ths" v-for="(title,index) in items" :key="index">
                            <div><a :href="title.url" target="_blank"><i class="glyphicon glyphicon-picture mr10"></i>{{ title.message }}</a></div>
                        </div>
                    </div>
                <div class="pb20">
                   <div class="row ">
                                ...
                                <div class="row  cr39-a cr39  tac pb30all">
                                    <div class="col-sm-2" v-for="(link,index) in list" :key="index">
                                        <ul class="lh30">
                                            ...
                                            <li><a href="javaScript:void(0);">{{ link.word }}</a></li>
                                            <li><a href="javaScript:void(0);">{{ link.word2 }}</a></li>
                                            <li><a href="javaScript:void(0);">{{ link.word3 }}</a></li>
        ...
        data () {
            return {
                items:[
                   {
                       message:'我家有宠 ',
                       url:'https://www.baidu.com/?tn=40020637_6_oem_dg'
                    },
                   {
                       message:'百萌争宠',
